...
fig_temp17 = px.line(df, x='sens_time', y='temp_pin17', color='room_name', text="sensor_1")
fig_temp19 = px.line(df, x='sens_time', y='temp_pin19', color='room_name', text="sensor_2")
fig_temp23 = px.line(df, x='sens_time', y='temp_pin23', color='room_name', text="sensor_3")
fig_temp32 = px.line(df, x='sens_time', y='temp_pin32', color='room_name', text="sensor_4")
fig_temp33 = px.line(df, x='sens_time', y='temp_pin33', color='room_name', text="sensor_5")
fig_hum17 = px.line(df, x='sens_time', y='humidity_pin17', color='room_name', text="sensor_1")
fig_hum19 = px.line(df, x='sens_time', y='humidity_pin19', color='room_name', text="sensor_2")
fig_hum23 = px.line(df, x='sens_time', y='humidity_pin23', color='room_name', text="sensor_3")
fig_hum32 = px.line(df, x='sens_time', y='humidity_pin32', color='room_name', text="sensor_4")
fig_hum33 = px.line(df, x='sens_time', y='humidity_pin33', color='room_name', text="sensor_5")
